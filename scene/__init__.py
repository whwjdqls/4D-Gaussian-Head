...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["IMAvatar"](args.source_path, sub_dir=args.scene ,video_length = args.video_length, train_sample_rate = args.train_sample_rate,test_sample_rate = args.test_sample_rate, use_mean_expression = False)
        else:
