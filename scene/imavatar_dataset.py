        ...
        for dir in sub_dir:
            ...
            for frame in camera_dict['frames']:
                ...
                if frame["file_path"].startswith('./'):
                    image_path = os.path.join(instance_dir, frame["file_path"][2:]+'.png')
                elif frame["file_path"].startswith('/'):
                    image_path = os.path.join(instance_dir, frame["file_path"][1:]+'.png')
                else:
                    image_path = os.path.join(instance_dir, frame["file_path"]+'.png')
